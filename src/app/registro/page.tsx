    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">Ya puedes iniciar sesión y completar tu perfil KYC.</p>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Empieza a invertir en minutos</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              ...
              <Link href="/terminos" className="text-blue-800 underline">Términos y condiciones</Link>
              {" "}y la{" "}
              <Link href="/privacidad" className="text-blue-800 underline">Política de privacidad</Link>.
            </p>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ¿Ya tienes cuenta?{" "}
            <Link href="/login" className="text-blue-800 font-medium hover:underline">Iniciar sesión</Link>
          </p>
        </div>
      </div>
    </div>
